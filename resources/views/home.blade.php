...
@section('main_content')
    ...
    <div class="card mb-3">
        <div class="card-header d-flex pt-1 pb-1">
            <div class="align-self-center">Длинные очереди</div>
            <div class="ms-auto">
            <span class="badge bg-info">Поликлиника №14</span>
            <p class="mb-0" style="font-size: 10pt;">29 июня 2022г 10:22</p>
            </div>
        </div>
